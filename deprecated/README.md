Compiled CSS output of the pre-token-migration codebase, for reference and visual
regression comparison only (served at /deprecated in Storybook for the "Theme"
toolbar toggle).

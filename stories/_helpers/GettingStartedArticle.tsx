      ...
      <section class="sec" id="steps">
        ...
        <div class="steps4">
          <a class="st" href="https://success.outsystems.com/Documentation/11/Developing_an_Application/Design_UI/Screen_Templates" target="_blank" rel="noopener">
            ...
            <svg class="pic" viewBox="0 0 124 74" fill="none" aria-hidden="true"><rect class="ps" x="14" y="18" width="52" height="38" rx="3"/><rect class="pa" x="14" y="18" width="52" height="8" rx="3"/><rect class="ps" x="76" y="12" width="26" height="50" rx="4"/><rect class="pa" x="76" y="12" width="26" height="7" rx="4"/></svg>
            <b>Create an app</b>
          ...
          <a class="st" href="https://success.outsystems.com/Documentation/11/Developing_an_Application/Design_UI/Screen_Templates" target="_blank" rel="noopener">
            ...
            <svg class="pic" viewBox="0 0 124 74" fill="none" aria-hidden="true"><rect class="ps" x="12" y="12" width="46" height="22" rx="3"/><rect class="pa" x="16" y="16" width="38" height="6" rx="2"/><rect class="ps" x="66" y="12" width="46" height="22" rx="3"/><rect class="pa" x="70" y="16" width="16" height="14" rx="2"/><rect class="ps" x="12" y="40" width="46" height="22" rx="3"/><rect class="pm" x="16" y="44" width="38" height="4" rx="2"/><rect class="pm" x="16" y="51" width="24" height="4" rx="2"/><rect class="ps" x="66" y="40" width="46" height="22" rx="3"/><rect class="pm" x="70" y="44" width="12" height="14" rx="2"/><rect class="pa" x="86" y="44" width="12" height="14" rx="2"/></svg>
            <b>Add screens</b>
          ...
          <a class="st" href="#patterns-detail">
            ...
            <svg class="pic" viewBox="0 0 124 74" fill="none" aria-hidden="true"><rect class="ps" x="10" y="10" width="48" height="54" rx="3"/><rect class="pa" x="14" y="16" width="40" height="10" rx="2"/><rect class="pp" x="18" y="20" width="24" height="3" rx="1.5"/><rect class="pm2" x="14" y="30" width="40" height="7" rx="2"/><rect class="pm2" x="14" y="41" width="40" height="7" rx="2"/><rect class="pm2" x="14" y="52" width="40" height="7" rx="2"/><path class="par" d="M62 37h10m-3-3 3 3-3 3" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round"/><rect class="ps" x="78" y="10" width="36" height="54" rx="3"/><rect class="pm" x="83" y="16" width="26" height="4" rx="2"/><rect class="paf" x="83" y="26" width="26" height="18" rx="3" stroke-width="1" stroke-dasharray="3 2"/><rect class="pm" x="83" y="50" width="18" height="4" rx="2"/></svg>
            <b>Use patterns</b>

...
| `--osui-dropdown-list-shadow` | `#{$token-elevation-3}` |
...
| `--osui-input-error-border-color` | `#{$token-border-danger-default}` |
...
| `--osui-list-item-hover-background` | `#{$token-bg-neutral-subtlest-hover}` |
...
_File: `src/scss/04-patterns/02-content/_card-background.scss`_

| Property | Default |
|---|---|
| `--osui-card-background-border-color` | `#{$token-border-subtle}` |
| `--osui-card-background-border-width` | `#{$token-border-size-025}` |
| `--osui-card-background-border-radius` | `var(--border-radius-softer)` |
...
| `--osui-card-border-radius` | `var(--border-radius-softer)` |
...
| `--osui-chat-message-status-line-height` | `#{$token-font-line-height-400}` |
...
| `--osui-list-item-content-text-line-height` | `#{$token-font-line-height-500}` |
...
| `--osui-section-title-line-height` | `#{$token-font-line-height-600}` |
| `--osui-section-content-line-height` | `#{$token-font-line-height-500}` |
...
| `--osui-accordion-item-border-radius` | `#{$token-border-radius-400}` |
...
| `--osui-accordion-item-title-hover-border-color` | `#{$token-border-default}` |
...
| `--osui-wizard-focus-halo-color` | `var(--color-focus-outer)` |
...
| `--osui-animated-label-error-color` | `#{$token-text-danger}` |
...
| `--osui-flatpickr-shadow` | `#{$token-elevation-3}` |
...
| `--osui-dropdown-ss-min-width` | `170px` |
...
| `--osui-balloon-shadow` | `#{$token-elevation-3}` |
...
| Property | Default |
|---|---|
| `--osui-rating-filled-color` | `var(--color-primary)` |
| `--osui-rating-empty-color` | `#{$token-bg-neutral-base-default}` |
...
<sub>541 properties across 80 components, generated from `src/scss`.</sub>

...
namespace OSFramework.Patterns.FloatingActions {
	export class FloatingActions extends AbstractPattern<FloatingActionsConfig> implements IFloatingActions {
		...
		private _floatingItems: Map<string, Patterns.FloatingActionsItem.IFloatingActionsItem>;
		...
		constructor(uniqueId: string, configs: any) {
			...
			this._floatingItems = new Map<string, Patterns.FloatingActionsItem.IFloatingActionsItem>();
		...
		public get floatingActionItems(): Map<string, Patterns.FloatingActionsItem.IFloatingActionsItem> {

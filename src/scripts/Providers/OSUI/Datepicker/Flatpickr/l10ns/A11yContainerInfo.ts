...
namespace Providers.OSUI.Datepicker.Flatpickr.l10ns {
	...
	export const A11yContainerInfo = {
		...
		cy: {
			htmlTex:
				"Er mwyn gallu llywio trwy'r calendr gydag allwedd bysellfwrdd: defnyddiwch allwedd saeth CMD neu CTRL + Down i lywio i gyd -destun calendr; Defnyddio allweddi saeth i lywio trwy ddiwrnodau calendr; Defnyddio allweddi saeth CMD neu Ctrl + dde neu chwith i lywio trwy fisoedd; Defnyddiwch allweddi saeth CMD neu CTRL + i fyny neu i lawr i lywio trwy flynyddoedd;",
		},
		da: {
			htmlTex:
				'For at kunne navigere gennem kalender med tastaturnøgle: Brug CMD eller Ctrl + Down Arrow -tasten til at navigere i kalenderkontekst; Brug piletaster til at navigere gennem kalenderdage; Brug CMD eller CTRL + højre eller venstre piletaster til at navigere gennem måneder; Brug CMD eller CTRL + op eller ned på piletasterne til at navigere gennem år;',
		},
		de: {
			htmlTex:
				'Um mit Tastaturschlüssel durch den Kalender navigieren zu können: Verwenden Sie CMD oder Strg + Down -Pfeil -Taste, um in den Kalenderkontext zu navigieren; Verwenden Sie Pfeilschlüssel, um durch Kalendertage zu navigieren. Verwenden Sie CMD- oder Strg + rechts oder linke Pfeiltasten, um Monate zu navigieren. Verwenden Sie CMD oder Strg + Up- oder Down -Pfeiltasten, um durch Jahre zu navigieren.',
		...
		en: {
			htmlTex:
				'In order to be able to navigate through calendar with keyboard key: Use cmd or ctrl + down arrow key to navigate into calendar context; Use arrow keys to navigate through calendar days; Use cmd or ctrl + right or left arrow keys to navigate through months; Use cmd or ctrl + up or down arrow keys to navigate through years;',
		},
		eo: {
			htmlTex:
				'Por povi navigi tra kalendaro per klavara ŝlosilo: Uzu CMD aŭ CTRL + malsupren sagoklavon por navigi en kalendaran kuntekston; Uzu sagajn ŝlosilojn por navigi tra kalendaraj tagoj; Uzu CMD aŭ CTRL + dekstran aŭ maldekstran sagoklavojn por navigi tra monatoj; Uzu CMD aŭ CTRL + supren aŭ malsupren sagoklavojn por navigi tra jaroj;',
		},
		es: {
			htmlTex:
		...
		et: {
			htmlTex:
				'Klaviatuuri klahviga kalendris liikumiseks: kasutage kalendri konteksti navigeerimiseks CMD või CTRL + Down Noole klahvi; Kasutage kalendripäevade liikumiseks nooleklahve; Kasutage kuude jooksul navigeerimiseks CMD või Ctrl + paremat või vasakut nooleklahvi; Kasutage aastate jooksul navigeerimiseks CMD või Ctrl + üles või alla nooleklahve;',
		},
		fa: {
			htmlTex:
				'برای اینکه بتوانید از طریق تقویم با کلید صفحه کلید حرکت کنید: از کلید Arrow CMD یا Ctrl + Down برای حرکت در متن تقویم استفاده کنید. از کلیدهای فلش برای حرکت در روزهای تقویم استفاده کنید. برای حرکت در طی ماهها از کلیدهای پیکان راست یا CTRL + راست یا چپ استفاده کنید. برای حرکت در طی سالها از کلیدهای Arrow CMD یا CTRL + بالا یا پایین استفاده کنید.',
		},
		fi: {
			htmlTex:
		...
		hy: {
			htmlTex:
				'Որպեսզի կարողանաք նավարկվել ստեղնաշարի ստեղնաշարի միջոցով. Օգտագործեք CMD կամ Ctrl + Down Arrow ստեղնը `օրացուցային համատեքստում նավարկելու համար. Օրացուցային օրերի միջոցով նավարկելու համար օգտագործեք սլաքների ստեղներ; Օգտագործեք CMD կամ CTRL + աջ կամ ձախ սլաքի ստեղներ `ամիսների միջոցով նավարկելու համար; Տարիներ շարունակ նավարկելու համար օգտագործեք CMD կամ CTRL + Up կամ Down Arrow ստեղներ.',
		},
		id: {
			htmlTex:
		...
		lv: {
			htmlTex:
				'Lai varētu pārvietoties pa kalendāru ar tastatūras atslēgu: izmantojiet CMD vai CTRL + lejupejošo bultiņas atslēgu, lai pārietu kalendāra kontekstā; Izmantojiet bulttaustiņus, lai pārvietotos kalendārajās dienās; Izmantojiet CMD vai CTRL + labās vai kreisās bultiņas taustiņus, lai pārvietotos mēnešos; Izmantojiet cmd vai ctrl + uz augšu vai uz leju bultiņu taustiņiem, lai pārvietotos pa gadiem;',
		},
		mk: {
			htmlTex:
				'За да можете да се движите низ календарот со копчето за тастатура: Користете го копчето CMD или Ctrl + Down Arrow за да се движите во контекст на календарот; Користете ги копчињата со стрела за да се движите низ календарските денови; Користете CMD или CTRL + десно или лево стрела со стрелки за да се движите низ месеци; Користете CMD или CTRL + UPAR или DOWN ARROW ARROW за да се движите низ години;',
		},
		mn: {
			htmlTex:
				'Гарын түлхүүрээр хуанлигаар дамжуулж явах боломжтой байхын тулд: CMD эсвэл CTTL + Down Arge Acew Aurow товчийг ашиглана уу; Календарийн өдрүүдийг дамжуулан чиглүүлэхийн тулд сумны товчлууруудыг ашиглана уу; CMD эсвэл CTD эсвэл CTRL + Баруун эсвэл зүүн сумыг ашиглан сараар дамжин өнгөрөх; CMD эсвэл CTRL + UP эсвэл AP A эсвэл DOWN ARCE товчийг ашиглан олон жилийн турш дамжин өнгөрөх;',
		},
		ms: {
			htmlTex:
		...
		my: {
			htmlTex:
				'ပြက္ခဒိန်ကို Keyboard Key ဖြင့်သွားလာနိုင်ရန်အတွက် CMD သို့မဟုတ် Ctrl + Down arrow ကိုသုံးပါ။ ပြက္ခဒိန်ရက်များမှတစ်ဆင့်သွားရန်မြှားသော့များကိုသုံးပါ။ လများလေသွားရန် CMD သို့မဟုတ် CTRL + လက်ဝဲသို့မဟုတ်လက်ဝဲမြှားခလုတ်များကိုသုံးပါ။ နှစ်ပေါင်းသွားရန် CMD သို့မဟုတ် Ctrl + Up သို့မဟုတ် Up arrow သော့များကိုသုံးပါ။',
		},
		nl: {
			htmlTex:
		...
		th: {
			htmlTex:
				'เพื่อให้สามารถนำทางผ่านปฏิทินด้วยคีย์บอร์ดคีย์บอร์ด: ใช้ปุ่มลูกศร CMD หรือ CTRL + ลงเพื่อนำทางไปยังบริบทของปฏิทิน ใช้ปุ่มลูกศรเพื่อนำทางผ่านวันปฏิทิน ใช้ปุ่มลูกศร CMD หรือ CTRL + ขวาหรือซ้ายเพื่อนำทางผ่านเดือน ใช้ปุ่มลูกศร CMD หรือ CTRL + ขึ้นหรือลงเพื่อนำทางผ่านปี',
		},
		tr: {
			htmlTex:
				'Klavye tuşu ile takvimde gezinebilmesi için: takvim bağlamında gezinmek için CMD veya CTRL + Down ok tuşunu kullanın; Takvim günlerinde gezinmek için ok tuşlarını kullanın; Aylar boyunca gezinmek için CMD veya CTRL + sağ veya sol ok tuşlarını kullanın; Yıllar boyunca gezinmek için CMD veya Ctrl + yukarı veya aşağı ok tuşlarını kullanın;',
		},
		uk: {
			htmlTex:
		...
		uz: {
			htmlTex:
				"Klaviatura kaliti bilan taqvimga o'tish imkoniyatiga ega bo'lish uchun: CMD yoki CTRL + pastga quyish tugmachasini kalendar kontekstiga o'tish uchun foydalaning; Taqvim kunlari orqali harakat qilish uchun o'q tugmalaridan foydalaning; Bir necha oy ichida harakatlanish uchun CMD yoki CTRL + o'ng yoki chap o'q tugmachalaridan foydalaning; CMD yoki CTRL + yuqoriga yoki pastga o'qishni yillar davomida o'tish uchun foydalaning;",
		},
		vn: {
			htmlTex:
				'Để có thể điều hướng qua lịch bằng phím bàn phím: sử dụng phím Mũi tên CMD hoặc CTRL + để điều hướng vào ngữ cảnh lịch; Sử dụng các phím mũi tên để điều hướng qua các ngày theo lịch; Sử dụng CMD hoặc CTRL + Phím mũi tên phải hoặc trái để điều hướng qua tháng; Sử dụng các phím mũi tên CMD hoặc CTRL + lên hoặc xuống để điều hướng qua nhiều năm;',
		},
		zh: {
			htmlTex:
				'為了能夠使用鍵盤鍵瀏覽日曆：使用cmd或ctrl + down箭頭鍵導航到日曆上下文中；使用箭頭鍵在日曆日內導航；使用cmd或ctrl +右或左箭頭鍵在幾個月中導航；使用CMD或CTRL +向上或向下箭頭鍵在多年中導航；',
		},
		zh_tw: {
			htmlTex:
				'为了能够使用键盘键浏览日历：使用cmd或ctrl + down箭头键导航到日历上下文中；使用箭头键在日历日内导航；使用cmd或ctrl +右或左箭头键在几个月中导航；使用CMD或CTRL +向上或向下箭头键在多年中导航；',
		},
	};
}

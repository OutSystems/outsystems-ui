/*!
OutSystems UI 2.27.0 • ODC Platform
Website:
...
declare namespace OSFramework.OSUI.ErrorCodes {
    ...
    const Tabs: {
        ...
        FailNoContentOrHeaderItemFound: string;
    };
...
declare namespace OSFramework.OSUI.Behaviors {
    ...
    class FocusTrap {
        ...
        private _focusBottomHandlerCallback;
        private _focusTopCallback;
        private _focusTopHandlerCallback;
...
declare namespace OSFramework.OSUI.Event.DOMEvents.Observers.MutationObservers.Lang {
    class LangObserver extends AbstractMutationObserver {
...
declare namespace OSFramework.OSUI.Event.DOMEvents.Observers.MutationObservers.Lang {
    class LangObserverConfigs implements MutationObserverInit {
...
declare namespace OSFramework.OSUI.Helper {
    abstract class DeviceInfo {
        ...
        static get HasCursorPointer(): boolean;
...
declare namespace OSFramework.OSUI.Helper {
    abstract class A11Y {
        ...
        static AriaModalFalse(element: HTMLElement): void;
        static AriaModalTrue(element: HTMLElement): void;
        ...
        static RoleDialog(element: HTMLElement): void;
        ...
        static RoleStatus(element: HTMLElement): void;
...
declare namespace OSFramework.OSUI.Patterns.AccordionItem {
    class AccordionItem extends AbstractChild<AccordionItemConfig, Accordion.IAccordion> implements IAccordionItem {
        ...
        constructor(uniqueId: string, configs: JSON);
        private get _elementWithEvents();
        private get _previousElementWithEvents();
        private _accordionOnClickHandler;
        private _addEvents;
        private _animationAsync;
        private _changeClikableTargetArea;
        private _handleTabIndex;
        private _onKeyboardPress;
        private _onToggleCallback;
        private _removeA11Properties;
        private _removeEvents;
        private _setA11ToogleElement;
...
declare namespace OSFramework.OSUI.Patterns.Dropdown.ServerSide {
    class OSUIDropdownServerSide extends Patterns.AbstractParent<OSUIDropdownServerSideConfig, Patterns.DropdownServerSideItem.IDropdownServerSideItem> implements IDropdownServerSide {
        ...
        private _moveBalloonOptionsWrapper;
        ...
        private _shouldBalloonOptionsBeMoved;
        private _touchMove;
...
declare namespace OSFramework.OSUI.Patterns.Rating {
    class Rating extends AbstractPattern<RatingConfig> implements IRating {
        ...
        private _eventOnRatingInputKeyup;
        ...
        private _setSize;
        private _setValue;
        private _toggleRatingInputsEvents;
        private _triggerOnSelectEvent;
        private _unsetEvents;
        private _updateClonePlaceholdersAttrs;
        protected setA11YProperties(): void;
        protected setCallbacks(): void;
        protected setHtmlElements(): void;
        protected unsetCallbacks(): void;
...
declare namespace OSFramework.OSUI.Patterns.SectionIndexItem {
    class SectionIndexItem extends AbstractChild<SectionIndexItemConfig, SectionIndex.ISectionIndex> implements ISectionIndexItem {
        ...
        private _setTargetAttributes;
        private _setTargetElement;
        private _setUpEvents;
        private _unsetTargetAttributes;
        protected setA11YProperties(): void;
        protected setCallbacks(): void;
        protected setHtmlElements(): void;
        protected unsetCallbacks(): void;
        ...
        dispose(): void;
        setIsActive(): void;
        setTargetScrollMargin(margin: number | string): void;
        unsetIsActive(): void;
        get IsSelected(): boolean;
        get TargetElement(): HTMLElement;
    }
...
declare namespace OutSystems.OSUI.ErrorCodes {
    ...
    const Utilities: {
        ...
        FailSetMenuOnReady: string;
        FailSetMenuOnDestroy: string;
    };
    const InlineSvg: {
        FailChangeProperty: string;
        FailDispose: string;
...
declare namespace OutSystems.OSUI.Patterns.AccordionItemAPI {
    ...
    function ToggleClickableZone(accordionItemId: string, isIconOnly: boolean): string;
}
...
declare namespace OutSystems.OSUI.Patterns.BottomSheetAPI {
    function ChangeProperty(bottomSheetId: string, propertyName: string, propertyValue: unknown): string;
...
declare namespace OutSystems.OSUI.Patterns.CarouselAPI {
    ...
    function ChangeProperty(carouselId: string, propertyName: string, propertyValue: unknown): string;
...
declare namespace OutSystems.OSUI.Patterns.DatePickerAPI {
    function ChangeProperty(datePickerId: string, propertyName: string, propertyValue: unknown): string;
    ...
    function OnRender(datePickerId: string): string;
...
declare namespace OutSystems.OSUI.Patterns.DropdownAPI {
    ...
    function Clear(dropdownId: string, silentOnChangedEvent?: boolean): string;
...
declare namespace OutSystems.OSUI.Patterns.DropdownServerSideItemAPI {
    function ChangeProperty(dropdownServerSideItemId: string, propertyName: string, propertyValue: unknown): string;
...
declare namespace OutSystems.OSUI.Patterns.FlipContentAPI {
    function ChangeProperty(flipId: string, propertyName: string, propertyValue: unknown): string;
...
declare namespace OutSystems.OSUI.Patterns.GalleryAPI {
    function ChangeProperty(galleryId: string, propertyName: string, propertyValue: unknown): string;
...
declare namespace OutSystems.OSUI.Patterns.InlineSvgAPI {
    function ChangeProperty(inlineSvgId: string, propertyName: string, propertyValue: unknown): string;
...
declare namespace OutSystems.OSUI.Patterns.MonthPickerAPI {
    function ChangeProperty(monthPickerId: string, propertyName: string, propertyValue: unknown): string;
    ...
    function OnRender(monthPickerId: string): string;
...
declare namespace OutSystems.OSUI.Patterns.NotificationAPI {
    function ChangeProperty(notificationId: string, propertyName: string, propertyValue: unknown): string;
...
declare namespace OutSystems.OSUI.Patterns.ProgressAPI {
    function ChangeProperty(progressId: string, propertyName: string, propertyValue: unknown): string;
...
declare namespace OutSystems.OSUI.Patterns.RatingAPI {
    function ChangeProperty(ratingId: string, propertyName: string, propertyValue: unknown): string;
    function Create(ratingId: string, configs: string): OSFramework.OSUI.Patterns.Rating.IRating;
    function Disable(ratingId: string): string;
    function Dispose(ratingId: string): string;
    function Enable(ratingId: string): string;
...
declare namespace OutSystems.OSUI.Patterns.SearchAPI {
    function ChangeProperty(searchId: string, propertyName: string, propertyValue: unknown): string;
...
declare namespace OutSystems.OSUI.Patterns.SectionIndexAPI {
    function ChangeProperty(sectionIndexId: string, propertyName: string, propertyValue: unknown): string;
...
declare namespace OutSystems.OSUI.Patterns.SectionIndexItemAPI {
    function ChangeProperty(sectionIndexItemId: string, propertyName: string, propertyValue: unknown): string;
...
declare namespace OutSystems.OSUI.Patterns.SubmenuAPI {
    function ChangeProperty(submenuId: string, propertyName: string, propertyValue: unknown): string;
...
declare namespace OutSystems.OSUI.Patterns.TabsContentItemAPI {
    function ChangeProperty(tabsContentItemId: string, propertyName: string, propertyValue: unknown): string;
...
declare namespace OutSystems.OSUI.Patterns.TabsHeaderItemAPI {
    function ChangeProperty(tabsHeaderItemId: string, propertyName: string, propertyValue: unknown): string;
...
declare namespace OutSystems.OSUI.Patterns.TimePickerAPI {
    function ChangeProperty(timePickerId: string, propertyName: string, propertyValue: unknown): string;
    ...
    function OnRender(timePickerId: string): string;
...
declare namespace OutSystems.OSUI.Patterns.TooltipAPI {
    function ChangeProperty(tooltipId: string, propertyName: string, propertyValue: unknown): string;
...
declare namespace OutSystems.OSUI.Utils.LayoutPrivate {
    abstract class CssBodyVariables {
        private static _checkDarkModeStatus;
        private static _checkHighContrastStatus;
        private static _isPhoneOrTablet;
        private static _setCssVars;
        private static _setNotWebApp;
        static Set(): void;
    }
}
declare namespace OutSystems.OSUI.Utils.LayoutPrivate {
...
declare namespace OutSystems.OSUI.Utils.Menu {
    const addMenuOnOrientationChange: (callback: OSFramework.OSUI.GlobalCallbacks.Generic) => void;
    const removeMenuOnOrientationChange: () => void;
    function IsMenuDraggable(): string;
    function MenuHide(): string;
    function MenuShow(): string;
    function OnDestroy(): string;
    function OnReady(callback: OSFramework.OSUI.GlobalCallbacks.Generic): string;
...
declare namespace OutSystems.OSUI.Utils {
    function ToggleClass(element: HTMLElement, state: unknown, className: string): void;
}
declare namespace OutSystems.OSUI.Utils {
...
declare namespace Providers.OSUI.Datepicker.Flatpickr {
    abstract class AbstractFlatpickr<C extends Flatpickr.AbstractFlatpickrConfig> extends OSFramework.OSUI.Patterns.DatePicker.AbstractDatePicker<Flatpickr, C> implements IFlatpickr {
        ...
        private _a11yMonthInformationElem;
        private _bodyScrollCommonBehaviour;
        private _flatpickrInputLabelElem;
        private _isPlatformInputDisabled;
        ...
        onCloseCustomCallback: any;
        constructor(uniqueId: string, configs: C);
        private _createA11yMonthInformationElem;
        private _onMonthChange;
        private _setAttributes;
        private _setCalendarCssClasses;
        private _setCurrentMonthAcessibilityInformation;
...
declare namespace Providers.OSUI.Datepicker.Flatpickr {
    abstract class AbstractFlatpickrConfig extends OSFramework.OSUI.Patterns.DatePicker.AbstractDatePickerConfig {
        private _disabledDays;
        private _disabledWeekDays;
        private _dynamicLang;
        ...
        OnClose: OSFramework.OSUI.GlobalCallbacks.Generic;
        OnMonthChange: OSFramework.OSUI.GlobalCallbacks.Generic;
        OnOpen: OSFramework.OSUI.GlobalCallbacks.Generic;
        constructor(config: JSON);
...
declare namespace Providers.OSUI.Dropdown.VirtualSelect {
    abstract class AbstractVirtualSelect<C extends Dropdown.VirtualSelect.AbstractVirtualSelectConfig> extends OSFramework.OSUI.Patterns.Dropdown.AbstractDropdown<VirtualSelect, C> implements IVirtualSelect {
        ...
        build(): void;
        changeProperty(propertyName: string, propertyValue: unknown): void;
        clear(silentOnChangedEvent?: boolean): void;
        close(): void;
        disable(): void;
        dispose(): void;
        enable(): void;
...
declare namespace Providers.OSUI.MonthPicker.Flatpickr {
    class OSUIFlatpickrMonth extends OSFramework.OSUI.Patterns.MonthPicker.AbstractMonthPicker<Flatpickr, FlatpickrMonthConfig> implements IFlatpickrMonth {
        ...
        private _bodyScrollCommonBehaviour;
        private _flatpickrButtonNextYearElem;
        private _flatpickrButtonPreviousYearElem;
        private _flatpickrInputLabelElem;
        private _flatpickrOpts;
        private _flatpickrYearInputElem;
        private _isPlatformInputDisabled;
        private _zindexCommonBehavior;
        protected flatpickrInputElem: HTMLInputElement;

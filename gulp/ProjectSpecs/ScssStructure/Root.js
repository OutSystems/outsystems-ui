...
const sectionInfo = {
    ...
    "assets": [
        ...
        },
        {
            ...
            // `.os-dark-theme`, so importing it is all dark mode needs.
            //
            ...
            // --token-* - so source order is a no-op. But `:root` and `.os-dark-theme` are
            ...
            "name": "Dark theme (opt-in via .os-dark-theme class)",

...
if (shell.test('-e', folderPath)) {
	shell.echo('Sorry, the folder already exists ' + folderPath);
} else {
...
if (shell.test('-e', scssFolderPath)) {
	shell.echo('Sorry, the folder already exists ' + scssFolderPath);
} else {
...
if (shell.test('-e', scssFilePath)) {
	shell.echo('Sorry, the folder already exists ' + scssFilePath);
} else {
...
//check if iterface file exists
if (shell.test('-e', interfaceFilePath)) {
	shell.echo('Sorry, the folder already exists ' + interfaceFilePath);
} else {
...
if (shell.test('-e', pattFilePath)) {
	shell.echo('Sorry, the folder already exists ' + pattFilePath);
} else {
...
if (shell.test('-e', pattAPIFilePath)) {
	shell.echo('Sorry, the folder already exists ' + pattAPIFilePath);
} else {
...
if (shell.test('-e', pattConfigFilePath)) {
	shell.echo('Sorry, the folder already exists ' + pattConfigFilePath);
} else {

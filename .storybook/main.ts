...
const config: StorybookConfig = {
	...
	staticDirs: [
		...
		// Pre-migration CSS snapshot (Phase 0 baseline) → served at /classic-theme/*
		// Used by the "Theme" toolbar toggle to compare the classic look against the new token theme.
		{ from: path.join(repoRoot, 'classic-theme'), to: '/classic-theme' },
